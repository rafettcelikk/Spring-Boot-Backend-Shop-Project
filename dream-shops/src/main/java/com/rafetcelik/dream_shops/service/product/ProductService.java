...
import com.rafetcelik.dream_shops.exception.ProductNotFoundException;
...
public class ProductService implements IProductService{
	...
	public Product addProduct(AddProductRequest request) {
		...
		if(productExists(request.getName(), request.getBrand())) {
			throw new AlreadyExistsException(request.getBrand() + " " + request.getName() + " zaten mevcut!");
		}
	...
	public Product updateProduct(ProductUpdateRequest request, Long productId) {
		return productRepository.findById(productId)
				...
				.orElseThrow(() -> new ProductNotFoundException("Ürün bulunamadı! ID: " + productId));
	}
