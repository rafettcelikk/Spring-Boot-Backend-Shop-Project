...
import com.rafetcelik.dream_shops.service.cart.ICartItemService;
...
public class CartItemController {
	...
	public ResponseEntity<ApiResponse> addItemToCart(
		...
		try {
			...
			return ResponseEntity.ok(new ApiResponse("Ürün başarıyla eklendi!", null));
	...
	public ResponseEntity<ApiResponse> removeItemFromCart(@PathVariable Long cartId, @PathVariable Long itemId) {
		try {
			...
			return ResponseEntity.ok(new ApiResponse("Ürün başarıyla kaldırıldı!", null));
		} catch (ResourceNotFoundException e) {
			return ResponseEntity.status(NOT_FOUND).body(new ApiResponse(e.getMessage(), null));		}
	}
	...
	public ResponseEntity<ApiResponse> updateItemQuantity(@PathVariable Long cartId,
		...
		try {
			...
			return ResponseEntity.ok(new ApiResponse("Ürün başarıyla güncellendi!", quantity));
		} catch (ResourceNotFoundException e) {
			return ResponseEntity.status(NOT_FOUND).body(new ApiResponse(e.getMessage(), null));
		}
	}
